...
my_mnemonic = os.getenv('mnemonic')
...
coins = {'eth':derive_wallets(mnemonic=my_mnemonic,coin=ETH,numderive=3),'btc-test': derive_wallets(mnemonic=my_mnemonic,coin=BTCTEST,numderive=3)}
